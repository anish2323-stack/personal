...
const Portfolio = () => {
  ...
  const projects = [
    {
      ...
      description: "Premium hosting services serving 1000+ clients including active YouTubers with enterprise-grade infrastructure and 99.9% uptime guarantee.",
      longDescription: "PowerDown Hosting represents the pinnacle of my hosting expertise, built from the ground up to serve 1000+ demanding clients including major YouTube content creators. The platform features enterprise-grade infrastructure, advanced DDoS protection, and a custom control panel designed for ease of use.",
      tech: ["Web Hosting", "Game Hosting", "DDoS Protection", "Custom Panel"],
      icon: Server,
      gradient: "from-emerald-500 to-green-600",
      category: "hosting",
      featured: true,
      stats: { clients: "1000+", uptime: "99.9%", servers: "Multiple Regions" },
      image: "https://images.pexels.com/photos/1148820/pexels-photo-1148820.jpeg?auto=compress&cs=tinysrgb&w=800"
    },
    {
      id: 2,
      title: "SwaggerCloud",
      description: "Enterprise cloud hosting solutions with UltraVM partnership, serving 200+ business clients with scalable infrastructure.",
      longDescription: "SwaggerCloud is an enterprise-focused hosting platform developed in partnership with UltraVM. It serves 200+ business clients with scalable cloud solutions, advanced networking capabilities, and enterprise-grade security features for businesses requiring robust infrastructure.",
      tech: ["Cloud Infrastructure", "Enterprise Solutions", "Scalability", "UltraVM Partnership"],
      icon: Cloud,
      gradient: "from-cyan-500 to-blue-600",
      category: "hosting",
      featured: false,
      stats: { clients: "200+", partnership: "UltraVM", focus: "Enterprise" },
      image: "https://images.pexels.com/photos/1181675/pexels-photo-1181675.jpeg?auto=compress&cs=tinysrgb&w=800"
    },
    {
      id: 7,
      title: "UltraVM Infrastructure",
      description: "High-performance virtual machine hosting and cloud infrastructure solutions for enterprise clients.",
      longDescription: "UltraVM provides enterprise-grade virtual machine hosting with high-performance infrastructure, scalable resources, and 24/7 support. Serving businesses that require reliable, powerful cloud computing solutions.",
      tech: ["Virtual Machines", "Cloud Computing", "Enterprise Infrastructure", "24/7 Support"],
      icon: Server,
      gradient: "from-purple-500 to-indigo-600",
      category: "hosting",
      featured: false,
      stats: { performance: "High-End", support: "24/7", scaling: "Enterprise" },
      image: "https://images.pexels.com/photos/1181675/pexels-photo-1181675.jpeg?auto=compress&cs=tinysrgb&w=800"
    },
    {
      id: 3,
      title: "DDoS Protection Services",
      description: "Comprehensive DDoS protection infrastructure for India & Nepal markets serving 300+ clients with real-time monitoring.",
      longDescription: "A specialized DDoS protection service designed specifically for the Indian and Nepalese markets, serving 300+ clients. Features include real-time traffic analysis, instant attack mitigation, and comprehensive reporting dashboards for clients.",
      tech: ["Network Security", "Traffic Filtering", "24/7 Monitoring", "Regional Focus"],
      icon: Shield,
      gradient: "from-blue-500 to-purple-600",
      category: "security",
      featured: false,
      stats: { clients: "300+", coverage: "India & Nepal", monitoring: "24/7" },
      image: "https://images.pexels.com/photos/60504/security-protection-anti-virus-software-60504.jpeg?auto=compress&cs=tinysrgb&w=800"
    },
    {
      id: 4,
      title: "Token SMP",
      description: "Building the biggest Minecraft server brand with 100+ servers and innovative gameplay mechanics.",
      longDescription: "Token SMP is an ambitious project aimed at creating the largest and most innovative Minecraft server network with 100+ servers. It features custom gameplay mechanics, advanced economy systems, and community-driven content creation tools.",
      tech: ["Minecraft Development", "Server Management", "Community Building", "Custom Plugins"],
      icon: Gamepad2,
      gradient: "from-purple-500 to-pink-600",
      category: "gaming",
      featured: true,
      stats: { servers: "100+", goal: "Biggest Brand", features: "Custom Gameplay" },
    ...
    },
    {
      ...
      description: "High-performance Minecraft server network with 15+ servers, custom plugins and optimized gameplay for 5000+ players.",
      longDescription: "LavaMC represents one of my most successful Minecraft server projects with 15+ servers, featuring custom-developed plugins, optimized performance configurations, and innovative gameplay mechanics that attracted 5000+ players.",
      tech: ["Custom Plugins", "Performance Optimization", "Player Management", "Anti-Cheat"],
      icon: Gamepad2,
      gradient: "from-red-500 to-orange-600",
      category: "gaming",
      featured: false,
      stats: { servers: "15+", players: "5000+", plugins: "Custom" },
      image: "https://images.pexels.com/photos/1174746/pexels-photo-1174746.jpeg?auto=compress&cs=tinysrgb&w=800"
    },
    {
      id: 6,
      title: "Infrastructure Consulting",
      description: "Expert consulting services for 50+ businesses with 4+ years experience optimizing digital infrastructure.",
      longDescription: "Providing comprehensive infrastructure consulting services to 50+ businesses with 4+ years experience, helping optimize hosting solutions, improve performance, and reduce costs while maintaining high availability and security standards.",
      tech: ["Architecture Review", "Performance Optimization", "Security Audit", "Migration Planning"],
      icon: Code,
      gradient: "from-green-500 to-teal-600",
      category: "consulting",
      featured: false,
      stats: { clients: "50+", experience: "4+ Years", focus: "Optimization" },
      image: "https://images.pexels.com/photos/1181675/pexels-photo-1181675.jpeg?auto=compress&cs=tinysrgb&w=800"
    }
  ];
  ...
  const stats = [
    { value: '1000+', label: 'Active Clients', icon: Users },
    { value: '100+', label: 'Minecraft Servers', icon: Gamepad2 },
